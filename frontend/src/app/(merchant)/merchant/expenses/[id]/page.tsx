...
export default function EditExpensePage() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: {
      ...
      const res = await apiClient.put(`/expenses/${expenseId}`, data);
      return res.data;
    },
    onSuccess: () => {
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <div className="text-center py-8">Loading expense...</div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the details of the expense</CardDescription>
        </CardHeader>
        <CardContent>
